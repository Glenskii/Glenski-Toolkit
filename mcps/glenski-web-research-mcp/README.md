...
This MCP server is the executable form of the **Web Research Prompt** created by Glenski Toolkit.
...
**Author and original prompt author:** [Glenski Toolkit](https://example.com)

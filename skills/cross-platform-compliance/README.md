...
```
Give the code or file path to an AI agent that supports skills, then request a cross-platform compliance audit. The skill returns tiered findings with exact fixes.

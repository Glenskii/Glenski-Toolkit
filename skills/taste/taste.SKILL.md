...
The following declarations pre-configure this skill for Glenski Toolkit Creative. They override the skill's baseline defaults where noted. Do not ask Glen to confirm these — they are established.
...
| example.com | Personal brand profile | Primary public-facing identity |
| www.example.com | Photography business | WordPress + standalone HTML overrides |
| apps.example.com | App showcases | Subdomains on Cloudflare Pages |
...
* **SERIF DISCIPLINE (VERY DISCOURAGED AS DEFAULT):**
  ...
  * **GLEN EXCEPTION:** Georgia is pre-approved for all Glenski Toolkit Creative properties. It is the established brand heading font, not a default reach. When working on any Glen property (see Brand Context above), Georgia headings are correct and do not need justification.
